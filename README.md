...
Los datos de las [Tarifas aplicadas de Gas Natural](https://www.datos.gov.co/Minas-y-Energ-a/Tarifas-aplicadas-de-Gas-Natural/ek3f-5wn4/about_data), fueron extraídos de los datos abiertos de la Republica de Colombia. Dónde se presentan los valores, en cantidad monetaria, de los cargos fijos, conexión, reconexión, precios si se tiene un precio en un rango de 0-20 $m^3$ y que tarifa prima si se supera ese volumen de consumo.
